...
```{python}
KNN_parameters = pd.read_csv(f"{analysis_results}BankNote_Authentication_Analysis_KNN_parameters.csv")
...
```{python}
count_table = pd.read_csv(f"{analysis_results}BankNote_Authentication_Analysis_classification_report.csv", index_col=0, dtype={'f1-score': 'float', 'support': 'int'})
